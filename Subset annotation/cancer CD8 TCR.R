...
CD8_subset_recur <- subset(x = CD8_subset, Type == 'Tumor' & Outcome == 'Recur' & Molecular_type == "GS" & Patient_ID_SPC != "NA")
CD8_subset_nonrecur <- subset(x = CD8_subset, Type == 'Tumor' & Outcome == 'Non_recur' & Molecular_type == "GS" & Patient_ID_SPC != "NA")
...
view(CD8_subset_recur@meta.data)
...
view(CD8_subset_nonrecur@meta.data)
...
CD8_rank_total_recur <- subset(x = CD8_rank_total, Type == 'Tumor' & Outcome == 'Recur'& Molecular_type == "GS")
...
CD8_rank_total_recur <- subset(x = CD8_rank_total, Type == 'Tumor' & Outcome == 'Recur'& p_top5 == T& Molecular_type == "GS")
DimPlot(CD8_rank_total_recur, reduction = 'umap', raster=FALSE, label = F) + ggtitle("")+NoLegend()+NoAxes()

CD8_rank_total_nonrecur <- subset(x = CD8_rank_total, Type == 'Tumor' & Outcome == 'Non_recur'& Molecular_type == "GS")
...
CD8_rank_total_nonrecur <- subset(x = CD8_rank_total, Type == 'Tumor' & Outcome == 'Non_recur'& p_top5 == T& Molecular_type == "GS")
...
CD8_expansion_mod <- subset(x = CD8_expansion_mod, Molecular_type == "GS")
...
CD8_expansion <- subset(x = CD8_expansion, Molecular_type == "GS")
#CD8_expansion <- subset(x = CD8_expansion, Molecular_type != "GS")
...
patient_id_nometa = c(59, 66, 44, 41, 18, 54, 4, 56, 52, 68, 29, 7, 36, 28, 8)
...
# Write the results_reshaped dataframe to a CSV file
write.csv(results_reshaped, file = "D:/DATA/Gastric cancer/GC CD8 TCR results counts per cluster.csv", row.names = FALSE)
...
patient_id_nometa = c(65,60,20,27,15,75,40,23,22,73,53,50,16,35,71)
...
# Write the results_reshaped dataframe to a CSV file
write.csv(results_reshaped, file = "D:/DATA/Gastric cancer/GC not CD8 TCR results counts per cluster.csv", row.names = FALSE)
...
# Write the results_reshaped dataframe to a CSV file
write.csv(results_reshaped, file = "D:/DATA/Gastric cancer/GC CD8 TCR results-2.csv", row.names = FALSE)
...
# Write the results_reshaped dataframe to a CSV file
write.csv(results_reshaped, file = "D:/DATA/Gastric cancer/GC CD8 TCR results-5.csv", row.names = FALSE)
...
# Write the results_reshaped dataframe to a CSV file
write.csv(results_reshaped, file = "D:/DATA/Gastric cancer/GC CD8 TCR results-10.csv", row.names = FALSE)
