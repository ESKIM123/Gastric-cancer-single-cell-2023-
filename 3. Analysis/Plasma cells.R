...
# Get data ----
immune_annotation <- readRDS(file="D:/DATA/Gastric cancer/immune_cell_clinical_data_modify.rds")
...
DefaultAssay(object = Plasma_subset) <- "integrated"
Plasma_subset
...
##################################### Plasma cells clustering ######################################### 

do_NebulosaPlot(sample = Plasma_subset_anno, features = "IGHA1", legend.position = "none", pt.size = 0.5, plot.title = "")
do_NebulosaPlot(sample = Plasma_subset_anno, features = "IGHM", legend.position = "none", pt.size = 0.5, plot.title = "")
do_NebulosaPlot(sample = Plasma_subset_anno, features = "IGHG1", legend.position = "none", pt.size = 0.5, plot.title = "")
do_NebulosaPlot(sample = Plasma_subset_anno, features = "SDC1", legend.position = "none", pt.size = 0.5, plot.title = "")
do_NebulosaPlot(sample = Plasma_subset_anno, features = "IGKC", legend.position = "none", pt.size = 0.5, plot.title = "")
do_NebulosaPlot(sample = Plasma_subset_anno, features = "IGLC21", legend.position = "none", pt.size = 0.5, plot.title = "")
